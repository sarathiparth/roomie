// questions.js — 36 questions across 6 sections
// Each question has: id, section, type, text, hint, options/range, dimension, weight
...
export const QUESTIONS = [
  ...
  },
  {
    ...
    dimension: 'clean',
    type: 'scenario_choice',
    text: 'How do you feel about shared spaces (living room, bathroom) having personal items left around indefinitely?',
...
export const HARD_FILTERS = {
  diet: { qId: 'q33', label: 'Diet' },
  lifestyle: { qId: 'q35', label: 'Life Stage' },
  oppositeGuestPolicy: { qId: 'q25', label: 'Guest Policy' },
};
